...
running = True
OUTPUT_DIR = 'results'
BASE_URL = 'http://xh6liiypqffzwnu5734ucwps37tn2g6npthvugz3gdoqpikujju525yd.onion/'
...
def crawl():
    ...
    try:
        ...
        for i in range(9000, 10000):
            next_page = BASE_URL + 'index.php/' + str(i)
...
def get_post(link):
    ...
    if content:
        ...
        for div in divs:
            try:
                #
                if('qa-main-heading' in div['class']):
...
def scrape(link):
    ...
    try:
        ...
        if content:
            ...
            tagsli = page.find_all('li', {'class' : 'qa-q-item-content.qa-post-content'})
